...
def GestisciLogin():
    ...
    if content_type == 'application/json':
        ...
        #read in db è per leggere le query
        ...
        if iNumRows == 1:
            ...
            #ritorna una tupla in cui alla posizione 0 c'è 0 se la query è andata a buon fine,
            #altrimenti 1. In posizione 1 c'è una lista con i valori della select
            #se inumrows > 1, devo fare d.read_next_row(cur) per ogni record(ennupla)
